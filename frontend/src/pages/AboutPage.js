      ...
      <section className="max-w-[800px] mx-auto px-8 py-24">
        <div className="space-y-12 font-body text-lg leading-relaxed">
          ...
          <div>
            ...
            <p className="text-muted-foreground mb-4">
              As a solo curator, Niharika personally discovers emerging designers, visits local markets, and builds relationships with homegrown labels across India. Each piece you see on Closetory has been handpicked, vetted for quality, and chosen because it tells a story worth wearing.
            </p>
            <p className="text-muted-foreground">
